...
*/
lcTouch.directive("ngTap", ["$timeout","$parse",
            ...
            elem.on("touchstart", function(startEvent) {
                ...
                tapHandler = function(endEvent) {
                    ...
                    if (target === endEvent.target) {
                        tapped = true;
                        return scope.$apply(function() { fn(scope, {$event:endEvent}); }); 
                    }
                };
...
*/
lcTouch.directive("ngDbltap", ["$timeout",
    function($timeout) {
        return function(scope, elem, attrs) {
...
lcTouch.directive("ngSwipeDown", ["$lcswipe",
    function($lcswipe) {
        return {
            restrict: "A",
...
lcTouch.directive("ngSwipeUp", ["$lcswipe",
    function($lcswipe) {
        return {
            restrict: "A",
            link: function(scope, elem, attrs) {
...
/*
lcTouch.directive("ngSwipeRight", ["$lcswipe",
    function($lcswipe) {
        return {
            restrict: "A",
            link: function(scope, elem, attrs) {
...
lcTouch.directive("ngSwipeLeft", ["$lcswipe",
    function($lcswipe) {
        return {
            restrict: "A",
            link: function(scope, elem, attrs) {
